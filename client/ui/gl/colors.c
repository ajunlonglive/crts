...
struct colors colors = {
	.ent = {
		...
		[et_smoke]    = { 0.3, 0.3, 0.3, 0.8 },
		[et_bomb] = { 0.0, 0.0, 0.0, 1.0 },
		[et_push] = { 0.0, 1.0, 0.0, 1.0 },
		[et_pull] = { 0.0, 0.0, 1.0, 1.0 },
		[et_dampener] = { 0.0, 0.2, 0.5, 0.5 },
		[et_accelerator] = { 0.0, 0.5, 0.2, 0.5 },
	},
	.tile = {
