...
static void
setup_chunk_borders(struct chunks *cnks, struct gl_ui_ctx *ctx)
{
	struct chunk *ck;
...
static void
trace_concrete_path(struct gl_ui_ctx *ctx, struct chunks *cnks, struct darr *path_points)
{
	uint32_t i;
...
void
render_pathfinding_overlay_setup_frame(struct client *cli, struct gl_ui_ctx *ctx)
{
	darr_clear(&points);
...
void
render_pathfinding_overlay(struct client *cli, struct gl_ui_ctx *ctx)
{
